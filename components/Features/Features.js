          ...
          <div className={`${styles.features_container} ${grid.col_8}`}>
            <div className={`${styles['content']}`}>
              ...
              <p className={`${styles['descrip']}`}>
                ...
                sapien rutrum mattis at sit amet purus. Fusce sed odio magna. Vestibulum ante ipsum
                primis in faucibus orci luctus et ultrices posuere cubilia curae; Donec ut arcu
                neque.
              </p>
